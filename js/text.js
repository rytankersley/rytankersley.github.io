...
var teachingJP = {
    ...
    questions: [{
        ...
        `,
        verseRef: "テモテへの手紙 第二 3:16-17, へブル人への手紙 4:12"
    },{
        index: 5,
        text: 
...
道を進んで行くうちに、水のある場所に来たので、宦官は言った。「見てください。水があります。私がバプテスマを受けるのに、何か妨げがあるでしょうか。」そして、馬車を止めるように命じた。ピリポと宦官は二人とも水の中に降りて行き、ピリポが宦官にバプテスマを授けた。
            `,
            `ローマ人への手紙 6:4, 例えば、 使徒の働き 2:38-41, 8:12, 36-38等`),
        createQuestion(1, 
...
function getTextData(langIndex) {
    var enCategories = [worshipEN, prayerEN, givingEN, missionEN, evangelismEN, discipleshipEN, teachingEN, leadershipEN,
        disciplineEN, fellowshipEN, membershipEN, ordinanceEN];
    var jpCategories = [worshipJP, prayerJP, givingJP, missionJP, evangelismJP, discipleshipJP, teachingJP, leadershipJP,
        disciplineJP, fellowshipJP, membershipJP, ordinanceJP];
    ...
    return data[langIndex];
};

function createQuestion(index, text, verse, verseRef) {
    return {
        index: index,
        text: text,
        verse: verse,
